...
def main(data_dir: str = ".") -> None:
    """
    Entry point: boot, then loop on user queries.
    The index is built ONCE and reused for every subsequent query.
    """
    print(BOLD_SEP)
    ...
    print(f"  System ready. {len(documents):,} documents indexed.\n")
